...
const TRANSLATIONS = {
  es: {
    ...
    sync_usage: '❌ Uso: yapu sync --brain-path <ruta-al-brain>\n   Ejemplo: yapu sync --brain-path ~/.gemini/antigravity-cli/brain/<uuid>',
    ...
    brain_usage: '❌ Uso: yapu brain <list|log> --path <ruta-al-brain>\n   Ejemplo: yapu brain list --path ~/.gemini/antigravity-cli/brain/<uuid>',
  ...
  en: {
    ...
    sync_usage: '❌ Usage: yapu sync --brain-path <path-to-brain>\n   Example: yapu sync --brain-path ~/.gemini/antigravity-cli/brain/<uuid>',
    ...
    brain_usage: '❌ Usage: yapu brain <list|log> --path <path-to-brain>\n   Example: yapu brain list --path ~/.gemini/antigravity-cli/brain/<uuid>',
    brain_list_title: '=== 🪺 YAPU BRAIN INSPECTOR ===\n',
