...
const TRANSLATIONS = {
  es: {
    ...
    init_hivemind_injecting: '🧠 Inyectando memoria global desde proyectos anteriores...',
    init_hivemind_header: '## 🧠 Mandamientos Globales (Aprendidos)',
    init_hivemind_description: 'Estas reglas fueron aprendidas por Yapu en proyectos anteriores y son de cumplimiento obligatorio.',
    init_hivemind_done: '✅ Mandamientos globales inyectados en PROJECT.md.',
  ...
  en: {
    ...
    init_hivemind_injecting: '🧠 Injecting global memory from previous projects...',
    init_hivemind_header: '## 🧠 Global Commandments (Learned)',
    init_hivemind_description: 'These rules were learned by Yapu in previous projects and are mandatory.',
    init_hivemind_done: '✅ Global commandments injected into PROJECT.md.',
