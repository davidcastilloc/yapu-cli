 ...
 * @property {string} name - Friendly name of the provider.
 * @property {string} executable - Executable filename in PATH.
 * @property {(homeDir: string) => string} brainPath - Resolves absolute brain/session path under home.
 * @property {(promptText: string, attachedFiles?: string[]) => string[]} buildSpawnArgs - Builds CLI spawn arguments array.
 * @property {(sessionDir: string) => string[]} transcriptCandidates - Resolves all candidate transcript file paths.
 */
 ...
 * @returns {Array<{ key: string, name: string, installed: boolean, hasData: boolean, dataPath: string }>}
 */
 ...
 * @returns {{ key: string, config: ProviderConfig }}
 */
